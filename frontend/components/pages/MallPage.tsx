...
const MallPage = () => {
    ...
    return (
        <main id="page-mall" className="page-content active" style={{ backgroundColor: '#0b0c10', color: '#fff', position: 'relative' }}>
            ...
            {/* 홈페이지 내부 쿠팡 제품 뷰어 + 하단 고정 장바구니/바로구매 버튼 모달 */}
            {activeCoupangProduct && (
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ 
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                ...
                                <span style={{ fontSize: '16px', fontWeight: 800, color: '#fff' }}>
                                    {activeCoupangProduct.name} - 제품 상세 보기
                                </span>
                            </div>
                        ...
                        {/* 모달 하단 고정 장바구니 & 바로구매 액션 바 (원하시던 구매/장바구니 버튼 배치) */}
                        <div style={{
                            padding: '16px 24px',
                            backgroundColor: '#121620',
