...
export const DEFAULT_CENTERS = [
    { 
        id: 'center-ydp', name: '피지컬케어 영등포 센터', tagline: '영등포 정밀 체형분석 센터', philosophy: '최첨단 장비를 활용한 정밀 분석', image_url: '', experts: ['김은주 교육이사', '박서준 수석 코치'], map_url: '', reserve_url: '', address: '서울특별시 영등포구 도신로 232',
    ...
    { 
        id: 'center-yyd', name: '피지컬케어 여의도 센터', tagline: '여의도 오피스 케어 지점', philosophy: '직장인 맞춤형 솔루션', image_url: '', experts: ['이민우 체형교정 전문가', '최윤아 책임 테라피스트'], map_url: '', reserve_url: '', address: '서울특별시 영등포구 국제금융로 10',
    ...
    { 
        id: 'center-gn', name: '피지컬케어 강남 센터', tagline: '강남 프리미엄 프라이빗 센터', philosophy: '1:1 VIP 케어', image_url: '', experts: ['정재희 재활의학 전문의', '한지환 시니어 코치'], map_url: '', reserve_url: '', address: '서울특별시 강남구 강남대로 364',
    ...
    { 
        id: 'center-sc', name: '피지컬케어 서초 센터', tagline: '서초 전문 스포츠 재활 센터', philosophy: '스포츠 과학 기반 케어', image_url: '', experts: ['송민혁 스포츠 사이언스 석사', '백지원 메디컬 트레이너'], map_url: '', reserve_url: '', address: '서울특별시 서초구 서초대로 314',
